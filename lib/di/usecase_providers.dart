...
import 'package:listyb/domain/usecases/lists/watch_all_counts_uc.dart'; // <<< NEW
...
// <<< NEW: все счётчики разом (listId -> counts)
final watchAllCountsUcProvider = Provider<WatchAllCountsUc>((ref) {
  final repo = ref.watch(listsRepositoryProvider);
  return WatchAllCountsUc(repo);
});
